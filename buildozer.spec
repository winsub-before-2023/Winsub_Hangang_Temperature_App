...
# (str) Package name
package.name = Winsub_hangang

# (str) Package domain (needed for android/ios packaging)
package.domain = hangang.life
...
#source.exclude_dirs = font,image
...
requirements = python3,kivy,bs4,beautifulsoup4,requests,lxml,urllib3,chardet,idna
